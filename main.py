...
def about():
    showinfo("About", '''This is a basic Text Editing program made in python.
             You can create/open/save text files and modify the text font, color and size!''')
...
font_menu.add_command(label = "Color", command=changecolor)
